    ...
    pub const STM32F103 = struct {
        ...
        pub const memory = struct {
            ...
            pub const RAM = struct {
                ...
                pub const length = 20 * KiB;
            };

            pub const FLASH = struct {
                pub const start = 0x8000000;
                pub const length = 64 * KiB;
            };
        };
        ...
        pub const peripherals = struct {
            ...
            ///  Universal asynchronous receiver transmitter
            pub const UART5 = @as(*volatile types.peripherals.UART5, @ptrFromInt(0x40005000));
            ...
            ///  General purpose I/O
            pub const GPIOF = @as(*volatile types.peripherals.GPIOA, @ptrFromInt(0x40011c00));
            ///  General purpose I/O
            pub const GPIOG = @as(*volatile types.peripherals.GPIOA, @ptrFromInt(0x40012000));
            ...
            ///  Analog to digital converter
            pub const ADC3 = @as(*volatile types.peripherals.ADC2, @ptrFromInt(0x40013c00));
            ///  General purpose timer
            pub const TIM9 = @as(*volatile types.peripherals.TIM9, @ptrFromInt(0x40014c00));
            ///  General purpose timer
            pub const TIM10 = @as(*volatile types.peripherals.TIM10, @ptrFromInt(0x40015000));
            ///  General purpose timer
            pub const TIM11 = @as(*volatile types.peripherals.TIM10, @ptrFromInt(0x40015400));
            ///  Secure digital input/output interface
            pub const SDIO = @as(*volatile types.peripherals.SDIO, @ptrFromInt(0x40018000));
            ///  DMA controller
            ...
            pub const FSMC = @as(*volatile types.peripherals.FSMC, @ptrFromInt(0xa0000000));
